  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="border-purple-700 bg-purple-900/20">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="mt-4 p-3 bg-gray-800/60 rounded-lg border border-gray-700">
            <p className="text-sm font-medium text-gray-200 mb-2">What Gemini AI will do:</p>
      ...
      <Card className="bg-gray-800 border-gray-700">
        <CardHeader>
          <CardTitle className="text-white">Enter Your Gemini API Key</CardTitle>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  placeholder="AIza..."
                  {...register('apiKey')}
                  className={`pr-10 bg-gray-700 border-gray-600 text-white placeholder:text-gray-400 ${errors.apiKey ? 'border-red-500' : ''}`}
                />
                <Button
                  type="button"
                  variant="ghost"
      ...
      {isConfigured && (
        <Card className="border-green-700 bg-green-900/20">
          <CardHeader>
            <CardTitle className="text-lg text-green-200">
              🚀 AI Features Enabled
            </CardTitle>
          </CardHeader>
          <CardContent>
